...
@interface GigFinderMasterViewController () {
...
- (void)viewDidLoad
{
    ...
    self.detailViewController = (GigFinderDetailViewController *)[[self.splitViewController.viewControllers lastObject] topViewController];
}
